...
covs = c('MSRP', 'EPA.Fuel.Economy.Est...City..MPG.', 'Passenger.Capacity', 'Passenger.Doors', 'Base.Curb.Weight..lbs.', 'Passenger.Volume..ft..', 'Wheelbase..in.', 'Track.Width..Front..in.', 'Height..Overall..in.', 'Fuel.Tank.Capacity..Approx..gal.', 'SAE.Net.Horsepower...RPM', 'Displacement', 'Stabilizer.Bar.Diameter...Front..in.',  'Front.tire.aspect.ratio', 'Front.tire.rim.size',
'Engine','Category','Manufacturer','Drivetrain','Trans.Type','Fuel.System','Trans.Description.Cont.','Suspension.Type...Front','Suspension.Type...Rear','Air.Bag.Frontal.Driver','Air.Bag.Frontal.Passenger','Air.Bag.Side.Body.Front','Air.Bag.Side.Body.Rear','Air.Bag.Side.Head.Front','Air.Bag.Side.Head.Rear','Brakes.ABS','Child.Safety.Rear.Door.Locks','Daytime.Running.Lights','Traction.Control','Night.Vision','Rollover.Protection.Bars','Fog.Lamps','Parking.Aid','Tire.Pressure.Monitor','Back.Up.Camera','Stability.Control','Front.Wheel.Material','Basic.Miles.km','Basic.Years','Corrosion.Miles.km','Corrosion.Years','Drivetrain.Miles.km','Drivetrain.Years','Roadside.Assistance.Years','Roadside.Assistance.Miles.km'   
         ))
```


```{r}
data_carprice <- data_carprice %>% select(!c(Stabilizer.Bar.Diameter...Front..in., Air.Bag.Side.Head.Front, Air.Bag.Side.Head.Rear, Roadside.Assistance.Years))


data_carprice_nomissing <- data_carprice %>% 
  tidyr::drop_na()

```

Since variables Stabilizer Bar Diameter Front in", "Air Bag Side Head Front", "Air Bag Side Head Rear", and "Roadside Assistance Years" have too many missing data, those variables will be eliminated. The new data has 4865 observations and 52 variables.   
